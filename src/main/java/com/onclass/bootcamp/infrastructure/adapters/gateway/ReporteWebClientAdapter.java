...
import com.onclass.bootcamp.infrastructure.entrypoints.dto.ReporteBootcampResponse;
import lombok.RequiredArgsConstructor;
import org.springframework.web.reactive.function.client.WebClient;
import reactor.core.publisher.Mono;

@RequiredArgsConstructor
public class ReporteWebClientAdapter implements ReporteCommandPort, ReporteQueryPort {
    ...
    @Override
    public Mono<Long> obtenerBootcampMasExitosoId() {
        return webClient.get()
                .uri("/reportes/bootcamps/mas-exitoso")
                .retrieve()
                .bodyToMono(ReporteBootcampResponse.class)
                .map(ReporteBootcampResponse::bootcampId);
    }
}
